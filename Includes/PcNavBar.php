...
<header class="<?php if($page == 'index' || $page == 'products'){echo 'indexNav';}?> main-header-media1200">
    <nav class="nav-media1200 main-nav-media1200">
        <ul class="animate__animated animate__backInDown">
            ...
            <li>
                <a class="business-name-media1200" href="index.php">
                    <img src="Assets/images/1.index/TMCPLOGO2.png" width="290" height="auto" alt="Logo">
                </a>
            </li>
            ...
            <li><a href="<?php echo $cartHref;?>" class="<?php if($page == 'cart'){echo 'active';}?>"><i class="bx bx-cart nav__cart"></i> <?php if(isset($_SESSION['item_quantity'])) {echo $_SESSION['item_quantity'];} else {echo "0";} ?></a></li>
