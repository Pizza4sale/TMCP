...
if(isset($_POST['submit']))
{
     ...
     {
            $sql = "UPDATE orderitem SET status='2',statusx='PAID' 
    ...
    WHERE orderID =$orderid and userID  =$userID and randidx = $randidx" ; 
        ...
        $query = "INSERT INTO table_cart_info (user_id,status,rc_number,date_create) VALUES ('$userID','ORDER COMPLETED','$randidx',NOW())";
