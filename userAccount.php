...
<body>
    ...
    <div id="screenRes" class="col-md-15">
        <div class="form-name-container">
            <div class="admin-subtitle">
                ...
                <span>&nbsp;HELLO <?php echo $titleName;?></span>
                <span class="user-logout">
                    <a href="logout.php">
                        <button type="button" title="Logout" class="btn btn-danger">
    ...
    <div class="container">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a data-toggle="pill" href="viewmyorders.php">Order History</a></li>
        </ul>
